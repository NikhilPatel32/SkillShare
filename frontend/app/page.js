        ...
        <main className="container mx-auto px-4 py-8">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Post skills you can teach others and help build a learning
                    community.
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Find people to exchange skills with. Teach what you know,
                    learn what you want.
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Build meaningful connections with other learners and grow
                    together.
                  </p>
                </div>
              </div>
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 mb-8">
              Join our community of skill sharers and start your learning
              journey today.
            </p>
            <Link
              href="/register"
